    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            if new_artist is None:
                ...
                # Store the current album in the currents artist collection then create a new artist object
        ...
        # After read the last line of the text file, we will have an artist and album that haven't been store -
        # process them now
