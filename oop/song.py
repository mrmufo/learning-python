class Song:
    ...
    Attributes:
        ...
        Modify the program so that the class structure matches
        the simplified diagram: Artist objects can hold references to Album
        objects and Album objects can hold references to Song objects.
    """
...
class Album:
    ...
    Attributes:
        ...
        artist (str): The name of the song's creator. If not specified,
